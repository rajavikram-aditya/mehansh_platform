...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-cream text-navy selection:bg-signal selection:text-navy">
      ...
      <main>
        <section className="relative min-h-[760px] overflow-hidden bg-navy pt-28 md:min-h-[820px]">
          ...
          <div className="absolute inset-0 bg-cover bg-center opacity-85" style={{ backgroundImage: "url('/manus-storage/mehansh-hero_0f1c8e24.jpg')" }} />
          ...
          <div className="relative mx-auto flex min-h-[650px] max-w-[1440px] flex-col justify-end px-5 pb-14 sm:px-8 md:min-h-[710px] md:pb-20 lg:px-12">
            <motion.div initial="hidden" animate="visible" variants={{ visible: { transition: { staggerChildren: 0.07 } } }} className="max-w-4xl">
              ...
              <motion.h1 variants={reveal} className="mt-8 font-display text-[clamp(4.1rem,10vw,9.3rem)] font-semibold leading-[0.76] tracking-[-0.055em] text-cream">
        ...
        <section id="founder" className="relative overflow-hidden bg-navy px-5 py-24 text-cream sm:px-8 lg:px-12 lg:py-32">
          ...
          <div className="relative mx-auto grid max-w-[1344px] gap-14 lg:grid-cols-[.8fr_1.2fr] lg:items-center">
        ...
        <section id="contact" className="relative overflow-hidden bg-cream px-5 py-24 sm:px-8 lg:px-12 lg:py-32">
          ...
          <div className="relative mx-auto grid max-w-[1344px] gap-12 lg:grid-cols-[.85fr_1.15fr]">
